...
public class FavouriteColor {
    public static void main(String[] args) {
        ...
        config.put(StreamsConfig.APPLICATION_ID_CONFIG,"favouriteColor-application");
        ...
        // 1 -->  // Step 1: We create the topic of users keys to colours
        KStream<String,String> favouriteColorInput = builder.stream("favourite-color-input");

        KStream<String, String> usersAndColours = favouriteColorInput
